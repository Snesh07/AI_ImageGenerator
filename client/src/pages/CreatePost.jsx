  ...
  const generateImage = async () => {
    if (form.prompt) {
      try {
        ...
        setForm({ ...form, photos: `data:image/jpeg;base64,${data.photo}` })
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        focus:ring-blue-500 focus:border-blue-500 w-64 h-64 p-3 flex justify-center items-center">
            {form.photo ? (
              ...
              <img
                src={preview}
                alt="preview"
                className="w-9/12 h-9/12 boject-contain opacity-40"
              />
            )}
        ...
        <div className="mt-5 flex gap-5">
          <button
            ...
            className="w-full text-white bg-green-700 font-medium rounded-md
          text-sm px-5 py-2.5 sm:w-auto text-center"
          >
